class CustomToolTip{#a={targetClass:"ctp-tooltip",collision:"window",enableCollision:!0,colors:{background:"#707070",text:"white",border:"#e1e1e1"},typoGraphy:{size:14,weight:200},transition:{duration:.4,delay:0,easing:"ease-in-out"}};#b={};#c={tp:{left:55,Width:window.innerWidth<=320?170:240,bottom:20,padding:2}};#d=()=>{};#e=()=>{};constructor(t={targetClass,collision,enableCollision,colors:{background,text,border},typoGraphy:{size,weight},transition:{duration,delay,easing}}){if(void 0===t){console.error("CustomTooltip | Options are not Declared");return}this.#f(t),this.#g(),this.#h(),this.#i()}#f(t){this.#b={targetClass:void 0!==t.targetClass?t.targetClass:this.#a.targetClass,collision:void 0!==t.collision?t.collision:this.#a.collision,enableCollision:void 0!==t.enableCollision?t.enableCollision:this.#a.enableCollision,colors:void 0!==t.colors?{background:void 0!==t.colors.background?t.colors.background:this.#a.colors.background,text:void 0!==t.colors.text?t.colors.text:this.#a.colors.text,border:void 0!==t.colors.border?t.colors.border:this.#a.colors.border}:this.#a.colors,typoGraphy:void 0!==t.typoGraphy?{size:void 0!==t.typoGraphy.size?t.typoGraphy.size:this.#a.typoGraphy.size,weight:void 0!==t.typoGraphy.weight?t.typoGraphy.weight:this.#a.typoGraphy.weight}:this.#a.typoGraphy,transition:void 0!==t.transition?{duration:void 0!==t.transition.duration?t.transition.duration:this.#a.transition.duration,delay:void 0!==t.transition.delay?t.transition.delay:this.#a.transition.delay,easing:void 0!==t.transition.easing?t.transition.easing:this.#a.transition.easing}:this.#a.transition}}#g(){let o="",i=!1,e=document.createElement("style"),s=`
        ...
        `;o+=`.ct-tooltip{${s}}`,o+=`.ct-body{${l}}`,o+=`.ct-active{${r}}`,o+=`.ct-tooltip::after{${n}}`,o+=a,o+=p,e.innerHTML=o,e.title="tpStyleSheet";let d=document.styleSheets;try{d.forEach(t=>{"tpStyleSheet"==t.title&&(i=!0)})}catch(h){}i||document.head.appendChild(e)}#j(c,u){c.getAttribute("tp-content")||c.setAttribute("tp-content",'Add your text content through "tp-content" attribute'),document.querySelector(`#tp${u}`)?.remove();let y=document.createElement("div");y.id=`tp${u}`,y.classList.add("ct-tooltip");let g=document.createElement("div");g.innerHTML=c.getAttribute("tp-content"),g.classList.add("ct-body"),y.appendChild(g),c.appendChild(y);let b=c.querySelector("div .ct-tooltip"),f=c.getAttribute("tp-content").length,$=this.#c.tp.Width+f/2;b.style.width=`${$}px`;let x=c.getBoundingClientRect(),m="window"==this.#b.collision?document.body.getBoundingClientRect():document.querySelector(this.#b.collision).getBoundingClientRect(),v=b.getBoundingClientRect(),C=m.right-v.right,w=m.left-v.left,S=x.top-v.bottom,k=m.top-v.top;w<0&&this.#b.enableCollision?b.style.left=`-${this.#c.tp.left-w-this.#c.tp.padding}px`:b.style.left=`-${v.width/2-this.#c.tp.padding}px`,C<0&&(b.style.left=`-${this.#c.tp.left-C+this.#c.tp.padding}px`),k>0?(b.style.bottom=`-${k+v.height/2+10}px`,b.setAttribute("isTopClipped",!0)):b.style.bottom=`${this.#c.tp.bottom+(S<0?Math.abs(S):0)}px`}#k(z){this.#l(z),z.querySelector("div .ct-tooltip").classList.add("ct-active")}#m(O){O.querySelector("div .ct-tooltip").classList.remove("ct-active")}#n(_){this.#l(_),_.querySelector("div .ct-tooltip").classList.toggle("ct-active")}#i(){let G;G=document.querySelectorAll(`.${this.#b.targetClass}`),Array.prototype.forEach.call(G,t=>{window.innerWidth<=768?(t.onclick=()=>{this.#n(t)},t.onmouseleave=()=>{this.#m(t),this.#e(t.querySelector("div .ct-tooltip"))}):(t.onmouseover=()=>{this.#k(t),this.#d(t.querySelector("div .ct-tooltip"))},t.onmouseleave=()=>{this.#m(t),this.#e(t.querySelector("div .ct-tooltip"))})})}#h(){let T=document.querySelectorAll(`.${this.#b.targetClass}`);T.forEach((t,o)=>{t.style.position="relative",t.style.lineHeight=1.25,this.#j(t,o+1)})}#l(R){let q=R.querySelector("div .ct-tooltip"),A=R.getBoundingClientRect(),D=q.getBoundingClientRect(),P=A.x+A.width/2-5-D.x;for(let B=0;B<document.styleSheets.length;B++){let L=document.styleSheets[B];"tpStyleSheet"==L.title&&(q.getAttribute("isTopClipped")?(L.cssRules[3].style.transform="rotateZ(222deg)",L.cssRules[3].style.bottom="unset",L.cssRules[3].style.top="-6px"):(L.cssRules[3].style.transform="rotateZ(45deg)",L.cssRules[3].style.bottom="-6px",L.cssRules[3].style.top="unset"),L.cssRules[3].style.left=`${P}px`)}}refresh(){window.onchange=()=>{this.#h(),this.#i()}}onHover(t){this.#d=t}onBlur(t){this.#e=t}}